      ...
      local function get_config()
        ...
        return {
          cmd = {
            ...
            "-configuration", mason_path .. "/jdtls/config_mac",
            "-data", workspace,
          },
          ...
          settings = {
            java = {
              ...
              configuration = {
                runtimes = {
                  { name = "JavaSE-25", path = vim.fn.expand("~/.local/share/mise/installs/java/corretto-25.0.2.10.1") },
                  { name = "JavaSE-21", path = vim.fn.expand("~/.local/share/mise/installs/java/corretto-21.0.10.7.1") },
                },
              },
            },
          },
          ...
          on_attach = function(_, bufnr)
            ...
            map("v", "<leader>je", function() jdtls.extract_variable(true) end,     "Java: extract variable")
